...
#3)
   ...
   Preparar(Preparar("harina","huevos"),CalentarSarten("sarten"))
   Rellenar(Preparar(Preparar("harina","huevos"),CalentarSarten("sarten")))
...
#6)
   Servir(Preparar(Calentar(Cortar("pan")),Moler(Cortar("palta"))),Rellenar(Preparar(Preparar("harina","huevos"),CalentarSarten("sarten"))),Preparar(Cortar("naranjas")),Calentar("cafe"))
...
Cortar("manzanas")
Preparar(Cortar("manzanas"),Cortar("pan"))
Moler(Cortar("manzanas"))
Rellenar(Preparar(Cortar("manzanas"),Cortar("pan")))
CalentarSarten("paila")
Calentar("huevos")
Servir(Cortar("manzanas"))